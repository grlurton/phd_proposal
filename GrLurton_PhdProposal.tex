...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TITLE
\newcommand{\reporttitle}{Bottom-up HMIS data use}
	...
	\begin{tikzpicture}[remember picture,overlay]
		\node at (current page.south west)
		{
			\begin{tikzpicture}[remember picture,overlay]
				...
				\pgftext[x=10.5cm,y=16.5cm,bottom,center]{\fontsize{30}{30}{\textbf{Defining a bottom-up approach}}};%\reporttitle
				\pgftext[x=10.5cm,y=15.2cm,bottom,center]{\fontsize{30}{30}{\textbf{to improve HMIS data use}}};
                \pgftext[x=10.5cm,y=13.9cm,bottom,center]{\fontsize{30}{30}{\textbf{in low resource settings}}};
