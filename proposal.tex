	...
	\begin{tikzpicture}[remember picture,overlay]
		\node at (current page.south west)
		{
			\begin{tikzpicture}[remember picture,overlay]
				...
				\pgftext[x=10.5cm,y=16.5cm,bottom,center]{\fontsize{30}{30}{\textbf{Data Hybridation approaches }}};%\reporttitle
				\pgftext[x=10.5cm,y=15.2cm,bottom,center]{\fontsize{30}{30}{\textbf{ in African HMIS}}};
