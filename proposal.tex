...
A prototype for doing has been proposed that allows easy tagging and mapping of indicators from different systems \[REF BLUSQUARE\]. A test realized with DHIS2 data from Bénin and with Results Based Funding indicators list allowed matching. XX
