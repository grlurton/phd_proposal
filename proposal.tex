	...
	\begin{tikzpicture}[remember picture,overlay]
		\node at (current page.south west)
            ...
            \begin{tikzpicture}[remember picture,overlay]
                ...
                \pgftext[x=9.1cm,y=1.8cm,bottom,left]{\includegraphics[width=6cm]{images/itech_logo.png}};
                \pgftext[x=17.1cm,y=1.8cm,bottom,left]{\includegraphics[width=3cm]{images/bluesquare_logo.png}};
...
This proposal relies on an approach of information systems as complex systems. We want to explore and evaluate methods and approaches that look outside the domain of technological and institutional solutions for health information systems. Our approach recognizes that limitations of health information systems come from technical as well as cultural and political reasons. Authors like Alain Desrosières and Ted Porter have shown how statistics and computation have come from and generated different cultures of public action in modern societies. The ambivalence of numbers as descriptors or norms has an influence on how information systems are thought as top-down normative systems. We aim at providing evidence on how this normative approach can be relaxed and what benefits can be drawn from this relaxation.

More specifically, we will present evidence on how various sources of data can be integrated in what is considered the health information system, and thus create a "data space" from which various actors can benefit. The hypothesis we make is that even in situations where HIS are deemed weak, a lot of information can be produced using innovative approaches to questions such as interoperability and analysis of low quality data. Using both a technical approach using innovative methods from the data science field, and a critical analysis of health information systems as social objects, we will explore how data currently produced in different health systems can be used and analyzed to produce valuable information.

More specifically, we will ask three main questions :
\begin{itemize}
\item How can metadata collected in an EMR be used to evaluate the impact of  a data system ?
\item How can non standardized HMIS sources be mapped and jointly analyzed ?% TODO justifier plus haut
\item How can multiple data source be integrated and analyzed to inform decision making at local level ?% TODO Justifier plus le secondary data usage
\end{itemize}


To answer this quesrtion %TODO delqyer un peu
We will conduct this research in four distinct aims :
\begin{description}
    \item[Aim 1] Evaluate the benefit of improved data collection for patient care ?
    ...
    \item[Aim 4] Develop a critical framework to analyze the theory and practices of Health Information Systems.
\end{description}
